...
const ResumeSection = ({ scrollDirection }) => (
  <section id="resume" className="relative py-20 bg-black text-center overflow-hidden">
    {/* Starfield background for consistency */}
    <StarfieldBackground className="section-background" particleCount={30} />
    
    <motion.h2
      className="text-3xl font-bold mb-8 text-accent relative z-10"
    ...
    <div className="flex flex-col md:flex-row justify-center gap-12 max-w-4xl mx-auto relative z-10">
      <motion.div
